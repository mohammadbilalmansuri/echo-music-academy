export default function Footer() {
  return (
    <footer
      id="contact-us"
      className="w-full relative flex flex-col items-center bg-dot-white/15"
    >
      <div className="w-full max-w-screen-2xl relative flex flex-col items-center text-center gap-10 px-5 pt-24 pb-8">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="flex items-center gap-3 mt-3">
            <a
              href="#"
              className="bg-white/10 hover:bg-white/20 p-3 rounded-full fill-white"
            >
              <svg viewBox="0 0 576 512" className="size-5">
            ...
            <a
              ...
              className="bg-white/10 hover:bg-white/20 p-3 rounded-full fill-white"
            >
              <svg viewBox="0 0 320 512" className="size-5">
